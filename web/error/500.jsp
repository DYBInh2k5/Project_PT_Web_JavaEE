...
<body class="bg-[#f6f7f9] min-h-screen flex items-center justify-center p-6">
    <div class="max-w-lg w-full bg-white rounded-2xl shadow-xl p-10 text-center border-t-8 border-[#dc2626]">
        <h1 class="headline text-5xl font-extrabold text-[#1f2937] mb-2">500</h1>
        <h2 class="headline text-2xl font-bold text-[#111827] mb-3">Loi he thong</h2>
        <p class="text-slate-500 mb-8">He thong dang gap loi. Vui long thu lai sau hoac lien he quan tri vien.</p>
