...
import com.project.web.filter.ActivityLogFilter;
import com.project.web.filter.AuthFilter;
import com.project.web.filter.EncodingFilter;
import com.project.web.filter.RoleFilter;
...
public class ServletFilterConfig {
    ...
    @Bean
    public FilterRegistrationBean<ActivityLogFilter> activityLogFilterRegistration() {
        FilterRegistrationBean<ActivityLogFilter> registration = new FilterRegistrationBean<>();
        registration.setFilter(new ActivityLogFilter());
        registration.addUrlPatterns("/*");
        registration.setName("ActivityLogFilter");
